  ...
  def test_update
    ...
    assert_pattern do
      response => {
        ...
        custom_fields: ^(FinchAPI::ArrayOf[FinchAPI::Models::Sandbox::EmploymentUpdateResponse::CustomField]) | nil,
        ...
        income_history: ^(FinchAPI::ArrayOf[FinchAPI::Models::Income, nil?: true]) | nil,
