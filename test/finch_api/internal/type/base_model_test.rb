...
class FinchAPI::Test::PrimitiveModelTest < Minitest::Test
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => FinchAPI::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      ...
      [FinchAPI::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [FinchAPI::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = FinchAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        FinchAPI::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [FinchAPI::Internal::Type::Boolean, true] => true,
      [FinchAPI::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => FinchAPI::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        FinchAPI::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = FinchAPI::Internal::Type::Converter.new_coerce_state
      FinchAPI::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        FinchAPI::Internal::Type::Converter.dump(target, input, state: state)
...
class FinchAPI::Test::EnumModelTest < Minitest::Test
  class E0
    include FinchAPI::Internal::Type::Enum
...
class FinchAPI::Test::UnionTest < Minitest::Test
  class U0
    include FinchAPI::Internal::Type::Union
...
class FinchAPI::Test::BaseModelQoLTest < Minitest::Test
  ...
  def test_equality
    cases = {
      ...
      [FinchAPI::Internal::Type::Boolean, FinchAPI::Internal::Type::Boolean] => true,
      [FinchAPI::Internal::Type::Unknown, FinchAPI::Internal::Type::Boolean] => false,
...
class FinchAPI::Test::MetaInfoTest < Minitest::Test
  A1 = FinchAPI::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = FinchAPI::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
