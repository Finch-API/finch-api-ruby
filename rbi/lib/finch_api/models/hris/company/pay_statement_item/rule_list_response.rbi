      ...
      module Company
        module PayStatementItem
          class RuleListResponse < FinchAPI::Internal::Type::BaseModel
            ...
            sig { returns(T.nilable(FinchAPI::Models::HRIS::Company::PayStatementItem::RuleListResponse::Attributes)) }
            ...
            sig do
              returns(
                T.nilable(T::Array[FinchAPI::Models::HRIS::Company::PayStatementItem::RuleListResponse::Condition])
              )
            end
            ...
            sig do
              returns(
                T.nilable(FinchAPI::Models::HRIS::Company::PayStatementItem::RuleListResponse::EntityType::TaggedSymbol)
              )
            end
            ...
            sig do
              params(
                entity_type: FinchAPI::Models::HRIS::Company::PayStatementItem::RuleListResponse::EntityType::OrSymbol
              )
                .void
            end
                ...
                .returns(
                  {
                    ...
                    conditions: T::Array[FinchAPI::Models::HRIS::Company::PayStatementItem::RuleListResponse::Condition],
                    created_at: Time,
                    effective_end_date: T.nilable(String),
                    effective_start_date: T.nilable(String),
                    entity_type: FinchAPI::Models::HRIS::Company::PayStatementItem::RuleListResponse::EntityType::TaggedSymbol,
                    priority: Integer,
                    updated_at: Time
                  }
                )
            ...
            class Condition < FinchAPI::Internal::Type::BaseModel
              ...
              sig do
                params(
                  operator: FinchAPI::Models::HRIS::Company::PayStatementItem::RuleListResponse::Condition::Operator::OrSymbol
                )
                  .void
              end
              ...
              sig do
                override
                  .returns(
                    {
                      field: String,
                      operator: FinchAPI::Models::HRIS::Company::PayStatementItem::RuleListResponse::Condition::Operator::TaggedSymbol,
                      value: String
                    }
                  )
              end
              ...
              module Operator
                ...
                sig do
                  override
                    .returns(
                      T::Array[FinchAPI::Models::HRIS::Company::PayStatementItem::RuleListResponse::Condition::Operator::TaggedSymbol]
                    )
                end
                def self.values
                end
            ...
            module EntityType
              ...
              sig do
                override
                  .returns(
                    T::Array[FinchAPI::Models::HRIS::Company::PayStatementItem::RuleListResponse::EntityType::TaggedSymbol]
                  )
              end
              def self.values
              end
