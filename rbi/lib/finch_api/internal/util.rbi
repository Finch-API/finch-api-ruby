...
module FinchAPI
  module Internal
    ...
    module Util
      ...
      #   structure when using `FinchAPI::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(FinchAPI::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(FinchAPI::Internal::Util::ServerSentEvent) }
