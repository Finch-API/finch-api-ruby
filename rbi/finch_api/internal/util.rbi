      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            FinchAPI::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: FinchAPI::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: FinchAPI::Internal::Util::ParsedUri,
            rhs: FinchAPI::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  FinchAPI::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
