  ...
  module Models
    module Sandbox
      class CompanyUpdateParams < FinchAPI::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[FinchAPI::Sandbox::CompanyUpdateParams::Account])
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                T.nilable(FinchAPI::Sandbox::CompanyUpdateParams::Department)
              ]
            )
          )
        end
        ...
        sig do
          returns(T.nilable(FinchAPI::Sandbox::CompanyUpdateParams::Entity))
        end
        attr_reader :entity
          ...
          override.returns(
            {
              accounts:
                T.nilable(
                  T::Array[FinchAPI::Sandbox::CompanyUpdateParams::Account]
                ),
              departments:
                T.nilable(
                  T::Array[
              ...
              ein: T.nilable(String),
              entity: T.nilable(FinchAPI::Sandbox::CompanyUpdateParams::Entity),
              legal_name: T.nilable(String),
        ...
        class Account < FinchAPI::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::Sandbox::CompanyUpdateParams::Account::AccountType::OrSymbol
              )
            )
          end
          ...
          module AccountType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  FinchAPI::Sandbox::CompanyUpdateParams::Account::AccountType
                )
              end
            ...
            CHECKING =
              T.let(
                :checking,
                FinchAPI::Sandbox::CompanyUpdateParams::Account::AccountType::TaggedSymbol
              )
            SAVINGS =
              T.let(
                :savings,
        ...
        class Department < FinchAPI::Internal::Type::BaseModel
          ...
          sig do
            params(
              parent:
                T.nilable(
                  FinchAPI::Sandbox::CompanyUpdateParams::Department::Parent::OrHash
                )
            ).void
          end
          attr_writer :parent
        ...
        class Entity < FinchAPI::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::Sandbox::CompanyUpdateParams::Entity::Subtype::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::Sandbox::CompanyUpdateParams::Entity::Type::OrSymbol
              )
            )
          end
          attr_accessor :type
          ...
          module Subtype
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  FinchAPI::Sandbox::CompanyUpdateParams::Entity::Subtype
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            S_CORPORATION =
              T.let(
                :s_corporation,
                FinchAPI::Sandbox::CompanyUpdateParams::Entity::Subtype::TaggedSymbol
              )
            C_CORPORATION =
              T.let(
                :c_corporation,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  FinchAPI::Sandbox::CompanyUpdateParams::Entity::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            LLC =
              T.let(
                :llc,
                FinchAPI::Sandbox::CompanyUpdateParams::Entity::Type::TaggedSymbol
              )
            LP =
              T.let(
                :lp,
