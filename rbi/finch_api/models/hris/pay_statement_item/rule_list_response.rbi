      ...
      module PayStatementItem
        class RuleListResponse < FinchAPI::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse,
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse::Attributes
              )
            )
          end
          ...
          sig do
            params(
              attributes:
                FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse::Attributes::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse::Condition
                ]
              )
            )
          end
          ...
          sig do
            params(
              conditions:
                T::Array[
                  FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse::Condition::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse::EntityType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              entity_type:
                FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse::EntityType::OrSymbol
            ).void
          end
          ...
          class Condition < FinchAPI::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse::Condition::Operator::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                operator:
                  FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse::Condition::Operator::OrSymbol
              ).void
            end
            ...
            module Operator
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse::Condition::Operator
                  )
                end
