      ...
      module PayStatementItem
        class RuleDeleteResponse < FinchAPI::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse,
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse::Attributes
              )
            )
          end
          ...
          sig do
            params(
              attributes:
                FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse::Attributes::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse::Condition
                ]
              )
            )
          end
          ...
          sig do
            params(
              conditions:
                T::Array[
                  FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse::Condition::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse::EntityType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              entity_type:
                FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse::EntityType::OrSymbol
            ).void
          end
          ...
          class Condition < FinchAPI::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse::Condition::Operator::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                operator:
                  FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse::Condition::Operator::OrSymbol
              ).void
            end
            ...
            module Operator
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse::Condition::Operator
                  )
                end
          ...
          module EntityType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse::EntityType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
