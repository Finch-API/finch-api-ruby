      ...
      module PayStatementItem
        class RuleCreateParams < FinchAPI::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                FinchAPI::HRIS::PayStatementItem::RuleCreateParams,
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::HRIS::PayStatementItem::RuleCreateParams::Attributes
              )
            )
          end
          ...
          sig do
            params(
              attributes:
                FinchAPI::HRIS::PayStatementItem::RuleCreateParams::Attributes::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  FinchAPI::HRIS::PayStatementItem::RuleCreateParams::Condition
                ]
              )
            )
          end
          ...
          sig do
            params(
              conditions:
                T::Array[
                  FinchAPI::HRIS::PayStatementItem::RuleCreateParams::Condition::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::HRIS::PayStatementItem::RuleCreateParams::EntityType::OrSymbol
              )
            )
          end
          ...
          class Condition < FinchAPI::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  FinchAPI::HRIS::PayStatementItem::RuleCreateParams::Condition::Operator::OrSymbol
                )
              )
            end
            ...
            module Operator
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    FinchAPI::HRIS::PayStatementItem::RuleCreateParams::Condition::Operator
                  )
                end
              ...
              EQUALS =
                T.let(
                  :equals,
                  FinchAPI::HRIS::PayStatementItem::RuleCreateParams::Condition::Operator::TaggedSymbol
                )
          ...
          module EntityType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  FinchAPI::HRIS::PayStatementItem::RuleCreateParams::EntityType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            PAY_STATEMENT_ITEM =
              T.let(
                :pay_statement_item,
                FinchAPI::HRIS::PayStatementItem::RuleCreateParams::EntityType::TaggedSymbol
              )
