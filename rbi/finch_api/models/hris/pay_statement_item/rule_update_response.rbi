      ...
      module PayStatementItem
        class RuleUpdateResponse < FinchAPI::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse,
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse::Attributes
              )
            )
          end
          ...
          sig do
            params(
              attributes:
                FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse::Attributes::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse::Condition
                ]
              )
            )
          end
          ...
          sig do
            params(
              conditions:
                T::Array[
                  FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse::Condition::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse::EntityType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              entity_type:
                FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse::EntityType::OrSymbol
            ).void
          end
          ...
          class Condition < FinchAPI::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse::Condition::Operator::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                operator:
                  FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse::Condition::Operator::OrSymbol
              ).void
            end
            ...
            module Operator
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse::Condition::Operator
                  )
                end
          ...
          module EntityType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse::EntityType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
