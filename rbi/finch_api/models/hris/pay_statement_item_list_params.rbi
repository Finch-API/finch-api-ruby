    ...
    module HRIS
      class PayStatementItemListParams < FinchAPI::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              FinchAPI::HRIS::PayStatementItemListParams,
        ...
        module Category
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                FinchAPI::HRIS::PayStatementItemListParams::Category
              )
            end
          ...
          EARNINGS =
            T.let(
              :earnings,
              FinchAPI::HRIS::PayStatementItemListParams::Category::TaggedSymbol
            )
          TAXES =
            T.let(
              :taxes,
