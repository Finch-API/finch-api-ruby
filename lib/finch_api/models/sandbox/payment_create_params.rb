    ...
    module Sandbox
      ...
      class PaymentCreateParams < FinchAPI::Internal::Type::BaseModel
        ...
        class PayStatement < FinchAPI::Internal::Type::BaseModel
          ...
          required :type, enum: -> { FinchAPI::Sandbox::PaymentCreateParams::PayStatement::Type }, nil?: true
          ...
          class Earning < FinchAPI::Internal::Type::BaseModel
            ...
            class Attributes < FinchAPI::Internal::Type::BaseModel
              # @!attribute metadata
              #
              #   @return [FinchAPI::Sandbox::PaymentCreateParams::PayStatement::Earning::Attributes::Metadata]
              required :metadata,
                       -> {
          ...
          class EmployeeDeduction < FinchAPI::Internal::Type::BaseModel
            ...
            class Attributes < FinchAPI::Internal::Type::BaseModel
              # @!attribute metadata
              #
              #   @return [FinchAPI::Sandbox::PaymentCreateParams::PayStatement::EmployeeDeduction::Attributes::Metadata]
              required :metadata,
                       -> {
          ...
          class EmployerContribution < FinchAPI::Internal::Type::BaseModel
            ...
            # @!method initialize(amount:, currency:, name:, type:, attributes: nil)
            ...
            class Attributes < FinchAPI::Internal::Type::BaseModel
              # @!attribute metadata
              #
              #   @return [FinchAPI::Sandbox::PaymentCreateParams::PayStatement::EmployerContribution::Attributes::Metadata]
              required :metadata,
                       -> {
          ...
          class Tax < FinchAPI::Internal::Type::BaseModel
            ...
            # @!method initialize(amount:, currency:, employer:, name:, type:, attributes: nil)
            ...
            class Attributes < FinchAPI::Internal::Type::BaseModel
              # @!attribute metadata
              #
              #   @return [FinchAPI::Sandbox::PaymentCreateParams::PayStatement::Tax::Attributes::Metadata]
              required :metadata,
                       -> {
