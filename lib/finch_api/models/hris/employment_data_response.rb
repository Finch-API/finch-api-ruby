  ...
  module Models
    module HRIS
      ...
      class EmploymentDataResponse < FinchAPI::Internal::Type::BaseModel
        # @!attribute body
        #
        #   @return [FinchAPI::Models::HRIS::EmploymentData::EmploymentData, FinchAPI::Models::HRIS::EmploymentData::BatchError]
        ...
        #   @param body [FinchAPI::Models::HRIS::EmploymentData::EmploymentData, FinchAPI::Models::HRIS::EmploymentData::BatchError]
        #
        #   @param code [Integer]
        #
