  ...
  module Models
    module HRIS
      ...
      class IndividualResponse < FinchAPI::Internal::Type::BaseModel
        # @!attribute body
        #
        #   @return [FinchAPI::Models::HRIS::Individual::Individual, FinchAPI::Models::HRIS::Individual::BatchError]
        ...
        #   @param body [FinchAPI::Models::HRIS::Individual::Individual, FinchAPI::Models::HRIS::Individual::BatchError]
        #   @param code [Integer]
