  ...
  module Internal
    module Type
      ...
      module Union
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, FinchAPI::Internal::Type::Converter, Class]
        #
        ...
        # @param value [Object]
        #
        # @return [FinchAPI::Internal::Type::Converter, Class, nil]
        private def resolve_variant(value)
          ...
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, FinchAPI::Internal::Util::OMIT)
            end

            return nil if key == FinchAPI::Internal::Util::OMIT
        ...
        def dump(value)
          if (target = resolve_variant(value))
            return FinchAPI::Internal::Type::Converter.dump(target, value)
          end

          known_variants.each do
            target = _2.call
            return FinchAPI::Internal::Type::Converter.dump(target, value) if target === value
          end
