        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              FinchAPI::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? FinchAPI::FilePart.new(value, filename: "upload") : value
          ...
          # @return [Object]
          def to_sorbet_type
            T.any(Pathname, StringIO, IO, String, FinchAPI::FilePart)
          end
        end
      end
    end
