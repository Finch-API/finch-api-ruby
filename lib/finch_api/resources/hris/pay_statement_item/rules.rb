    ...
    class HRIS
      class PayStatementItem
        class Rules
          ...
          #
          # @param conditions [Array<FinchAPI::Models::HRIS::PayStatementItem::RuleCreateParams::Condition>] Body param
          #
          ...
          #
          # @param entity_type [Symbol, FinchAPI::Models::HRIS::PayStatementItem::RuleCreateParams::EntityType] Body param: The entity type to which the rule is applied.
          #
          # @param request_options [FinchAPI::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [FinchAPI::Models::HRIS::PayStatementItem::RuleCreateResponse]
          #
          # @see FinchAPI::Models::HRIS::PayStatementItem::RuleCreateParams
          def create(params = {})
            query_params = [:entity_ids]
            parsed, options = FinchAPI::HRIS::PayStatementItem::RuleCreateParams.dump_request(params)
            ...
            @client.request(
              ...
              model: FinchAPI::Models::HRIS::PayStatementItem::RuleCreateResponse,
          ...
          # @param request_options [FinchAPI::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse]
          #
          # @see FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateParams
          def update(rule_id, params = {})
            query_params = [:entity_ids]
            parsed, options = FinchAPI::HRIS::PayStatementItem::RuleUpdateParams.dump_request(params)
            query = FinchAPI::Internal::Util.encode_query_params(parsed.slice(*query_params))
            @client.request(
              method: :put,
              ...
              query: query,
              body: parsed.except(*query_params),
              model: FinchAPI::Models::HRIS::PayStatementItem::RuleUpdateResponse,
              security: {bearer_auth: true},
              options: options
            )
          end
          ...
          # @param request_options [FinchAPI::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [FinchAPI::Internal::ResponsesPage<FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse>]
          #
          # @see FinchAPI::Models::HRIS::PayStatementItem::RuleListParams
          def list(params = {})
            parsed, options = FinchAPI::HRIS::PayStatementItem::RuleListParams.dump_request(params)
            ...
            @client.request(
              ...
              model: FinchAPI::Models::HRIS::PayStatementItem::RuleListResponse,
              security: {bearer_auth: true},
              options: options
            )
          end
          ...
          # @param request_options [FinchAPI::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse]
          #
          # @see FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteParams
          def delete(rule_id, params = {})
            parsed, options = FinchAPI::HRIS::PayStatementItem::RuleDeleteParams.dump_request(params)
            query = FinchAPI::Internal::Util.encode_query_params(parsed)
            @client.request(
              method: :delete,
              path: ["employer/pay-statement-item/rule/%1$s", rule_id],
              query: query,
              model: FinchAPI::Models::HRIS::PayStatementItem::RuleDeleteResponse,
              security: {bearer_auth: true},
              options: options
            )
          end
