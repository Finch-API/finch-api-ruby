  ...
  module Resources
    class HRIS
      class PayStatementItem
        # @return [FinchAPI::Resources::HRIS::PayStatementItem::Rules]
        attr_reader :rules
        ...
        #
        # @return [FinchAPI::Internal::ResponsesPage<FinchAPI::Models::HRIS::PayStatementItemListResponse>]
        #
        # @see FinchAPI::Models::HRIS::PayStatementItemListParams
        def list(params = {})
          parsed, options = FinchAPI::HRIS::PayStatementItemListParams.dump_request(params)
          ...
          @client.request(
            ...
            model: FinchAPI::Models::HRIS::PayStatementItemListResponse,
        ...
        def initialize(client:)
          @client = client
          @rules = FinchAPI::Resources::HRIS::PayStatementItem::Rules.new(client: client)
        end
      end
    end
  end
